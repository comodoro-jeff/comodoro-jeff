...
### Profissional em formação na área de Dados | Análise de Dados • Ciência de Dados • Machine Learning
...
Prova de conceito acadêmica que integra **Internet das Coisas (IoT) e Ciência de Dados** para coleta e previsão de variáveis ambientais.
